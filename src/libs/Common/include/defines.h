...
{
    return static_cast<uint32_t>(b) | (static_cast<uint32_t>(g) << 8ul) | (static_cast<uint32_t>(r) << 16ul);
}

constexpr uint32_t ARGB(uint8_t a, uint8_t r, uint8_t g, uint8_t b) {
    return static_cast<uint32_t>(b) | (static_cast<uint32_t>(g) << 8ul) | (static_cast<uint32_t>(r) << 16ul) | (static_cast<uint32_t>(a) << 24ul);
}
